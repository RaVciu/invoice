...
namespace WindowsFormsApplication1.DataSet1TableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [employee] ([id], [firstname], [lastname], [title], [age], [yearofservice], [salary], [perks], [email]) VALUES (@id, @firstname, @lastname, @title, @age, @yearofservice, @salary, @perks, @email);
...
SELECT id, firstname, lastname, title, age, yearofservice, salary, perks, email FROM employee WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        id, firstname, lastname, title, age, yearofservice, salary, perks, " +
                "email\r\nFROM            employee";
